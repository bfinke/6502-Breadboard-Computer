...
reset:
    ...
    lda number + 1 ; this is because it is a 2 byte number so we have to load the second half
    sta value + 1
...
number: .word 1729 ; this will converted to binary on the ROM when compiled
